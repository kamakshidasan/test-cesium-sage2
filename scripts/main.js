...
function init(self){
  ...
  var imagen = layers.addImageryProvider(new Cesium.SingleTileImageryProvider({
      url : self.resrcPath+'images/img.png',
...
function initsim(t, self){
  ...
  //material
	var vshader = self.resrcPath+"shaders/vshader.glsl";
	var mFshader = self.resrcPath+"shaders/mFshader.glsl";
